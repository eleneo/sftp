...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/eleneo/sftp/build?logo=github) ![GitHub stars](https://img.shields.io/github/stars/eleneo/sftp?logo=github) ![Docker Stars](https://img.shields.io/docker/stars/eleneo/sftp?label=stars&logo=docker) ![Docker Pulls](https://img.shields.io/docker/pulls/eleneo/sftp?label=pulls&logo=docker)

![OpenSSH logo](https://raw.githubusercontent.com/eleneo/sftp/master/openssh.png "Powered by OpenSSH")

# Supported tags and respective `Dockerfile` links

- [`debian`, `latest` (*Dockerfile*)](https://github.com/eleneo/sftp/blob/master/Dockerfile) ![Docker Image Size (debian)](https://img.shields.io/docker/image-size/eleneo/sftp/debian?label=debian&logo=debian&style=plastic)
- [`alpine` (*Dockerfile*)](https://github.com/eleneo/sftp/blob/master/Dockerfile-alpine) ![Docker Image Size (alpine)](https://img.shields.io/docker/image-size/eleneo/sftp/alpine?label=alpine&logo=Alpine%20Linux&style=plastic)
...
```
docker run -p 22:22 -d eleneo/sftp foo:pass:::upload
```
...
Tip: you can use [eleneo/makepasswd](https://hub.docker.com/r/eleneo/makepasswd/) to generate encrypted passwords:
`echo -n "your-password" | docker run -i --rm eleneo/makepasswd --crypt-md5 --clearfrom=-`
...
**NOTE:** Using `mount` requires that your container runs with the `CAP_SYS_ADMIN` capability turned on. [See this answer for more information](https://github.com/eleneo/sftp/issues/60#issuecomment-332909232).
